...
var controller = (function(){
	...
	function init(){
		//document.write('<img src="elements/ajax-loader.gif" width="128" height="15" id="loading" />');
				
		yepnope({
		  load: [
			'/socket.io/socket.io.js',
			'http://fonts.googleapis.com/css?family=Open+Sans:400,700,800,300&test.css',
			'http://cdnjs.cloudflare.com/ajax/libs/store.js/1.3.14/store.min.js',
			'http://ajax.googleapis.com/ajax/libs/jquery/1.10.2/jquery.min.js',
			'http://cdnjs.cloudflare.com/ajax/libs/handlebars.js/1.0.0/handlebars.min.js',
			'http://cdnjs.cloudflare.com/ajax/libs/jquery-mockjax/1.5.2/jquery.mockjax.js',
	...
	function load(){
		...
		if (window.config.socket){
			...
			socket.emit('remote', {activePage: Page.getCurrent().url});
